...
def add_blog_articles(apps, schema_editor):
    ...
    articles = [
        ...
        {'category': news_category, 'title': 'Мы запустили блог',
         'text_preview': 'На сайте нашего магазина запускается блог, где вы сможете узнать свежую информацию',
        ...
        {'category': news_category, 'title': 'Категории блога',
         'text_preview': 'Теперь наш блог разбит на категории и вы сможете читать только самые интересные для вас рубрики',
